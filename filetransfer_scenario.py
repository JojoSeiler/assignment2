...
#title           :filetransfer_scenario.py
#description     :This the modified base_scenario
#author          :Group 8
#date            :15.01.2018
#version         :0.1
#usage           :python filetransfer_scenario.py
#notes           :
...
def topology():
    ...
    print "*** Starting FileTransferserver on H1"
    h1.cmdPrint('python -m server &')

    print "*** Starting FileTransferclient on sta1"
    sta1.cmdPrint('python -m client &')
